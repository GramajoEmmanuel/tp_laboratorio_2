...
{
    public class Concecionaria //Eliminado modificador abstract
    {
        ...
        public Concecionaria(int espacioDisponible):this() //Corregido para llamar al constructor sin parametros e inicializar la lista de vehiculos
        {
        ...
        /// <returns></returns>
        public static string Mostrar(Concecionaria concecionaria, ETipo tipoDeVehiculo) //Agregado el static
        {
            ...
            {
                switch (tipoDeVehiculo) //Corregido el switch para que muestre solamente los vehiculos correspondientes
                {
