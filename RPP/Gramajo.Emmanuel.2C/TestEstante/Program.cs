...
namespace TestEstante
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Se cren 2 xml guardando la informacion de cada estante
            Estante.SerializarEstante(est1.GetProductos(),"\\estante1.xml");
            Estante.SerializarEstante(est2.GetProductos(),"\\estante2.xml");
